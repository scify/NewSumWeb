        ...
        <div class="hero-unit" style="background-color: #d9d9d9">
            ...
            if ($lang == "en") {
                echo ' <h2>Unfortunately, our server is offline...</h2>
                        ...
                        <p><a href="index.php?lang=  ' . $lang . ' " class="btn btn-inverse btn-small">Reload Page</a></p> ';
            } else {
                echo ' <h2>Δυστυχώς, ο server μας είναι εκτός λειτουργίας...</h2>
                        ...
                        <p><a href="index.php?lang=' . $lang . ' " class="btn btn-inverse btn-small">Αρχική σελίδα</a></p> ';
            }
            ?>
    </body>
</html>
