                        ...
                        if (!isset($_SESSION["USER_ID"])){
                            echo '
                                <form class="form-horizontal pull-right" style="margin-top: 14px;margin-right: 20px;" method="POST" action="./index.php">
                                    <input type="email" title="E-mail" placeholder="E-mail" name="login" class="input-medium" required><br class="hidden-desktop">
                                    <input type="password" pattern="[^\']{6,18}" title="6-18 characters" name="pass" placeholder="Password" class="input-medium" required><br class="hidden-desktop">
